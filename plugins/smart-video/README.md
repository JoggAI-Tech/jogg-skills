...
Release `0.8.20` provides the Smart Video Skill, editor workflow, media
...
`bootstrap` installs `@joggai/smartvideo@0.1.13` into the user's managed Smart
