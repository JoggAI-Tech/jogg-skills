...
Release `0.8.18` provides the Smart Video Skill, editor workflow, media
...
`bootstrap` installs `@joggai/smartvideo@0.1.11` into the user's managed Smart
