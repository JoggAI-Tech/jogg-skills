...
This is the authoring and approval workflow for information-layer HTML. It
...
rule only to `.mg-backdrop`; content remains fully opaque. Do not use scripts,
...
3. Use `apply-html`, or [echarts-authoring.md](echarts-authoring.md) plus
