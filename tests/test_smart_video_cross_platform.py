...
class SmartVideoCrossPlatformContractTests(unittest.TestCase):
    ...
    def test_runtime_bom_pins_the_complete_package_set(self) -> None:
        ...
        self.assertEqual(plugin["version"].split("+", 1)[0], "0.8.18")
        self.assertEqual(bom["plugin_version"], "0.8.18")
        self.assertEqual(release["version"], "0.8.18")
        expected = {
        ...
        self.assertEqual(bom["aggregate"], {"name": "@joggai/smartvideo", "version": "0.1.11"})
        ...
        self.assertEqual(
            bom["packages"],
            {
                ...
                "@joggai/smartvideo-runtime": "0.1.9",
        ...
        self.assertEqual(
            bom["packaged_assets"],
            {
                "owner": "@joggai/smartvideo-runtime@0.1.9",
        ...
        self.assertEqual(
            bom["distribution"],
            {
                ...
                "package": "@joggai/smartvideo@0.1.11",
        ...
        self.assertEqual(
            ...
            {
                "classroom-presenter": "npx --yes @joggai/smartvideo@0.1.11 resources install classroom-presenter",
                "office-presenter": "npx --yes @joggai/smartvideo@0.1.11 resources install office-presenter",
            },
        )
        expected_driver = {
            "driver_id": "avatar-engine",
            "package": "@joggai/smartvideo-avatar@0.1.3",
            ...
            "engine_package": "@joggai/smartvideo-avatar-engine@0.1.1",
    ...
    def test_uninstalled_doctor_is_read_only_machine_json(self) -> None:
        ...
        self.assertEqual(report["required"], "@joggai/smartvideo@0.1.11")
