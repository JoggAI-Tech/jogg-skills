...
class SmartVideoCrossPlatformContractTests(unittest.TestCase):
    ...
    def test_runtime_bom_pins_the_complete_package_set(self) -> None:
        ...
        self.assertEqual(plugin["version"].split("+", 1)[0], "0.8.19")
        self.assertEqual(bom["plugin_version"], "0.8.19")
        self.assertEqual(release["version"], "0.8.19")
        expected = {
        ...
        self.assertEqual(bom["aggregate"], {"name": "@joggai/smartvideo", "version": "0.1.12"})
        ...
        self.assertEqual(
            bom["packaged_assets"],
            {
                "owner": "@joggai/smartvideo-runtime@0.1.10",
        ...
        self.assertEqual(
            bom["distribution"],
            {
                ...
                "package": "@joggai/smartvideo@0.1.12",
        ...
        self.assertEqual(
            ...
            {
                "classroom-presenter": "npx --yes @joggai/smartvideo@0.1.12 resources install classroom-presenter",
                "office-presenter": "npx --yes @joggai/smartvideo@0.1.12 resources install office-presenter",
            },
        )
        expected_driver = {
    ...
    def test_uninstalled_doctor_is_read_only_machine_json(self) -> None:
        ...
        self.assertEqual(report["required"], "@joggai/smartvideo@0.1.12")
